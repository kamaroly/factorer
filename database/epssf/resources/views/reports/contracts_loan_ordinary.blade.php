...
<h3 style="text-align: center;text-decoration: underline">Eastern province staff solidatity fund  <p>Loan agreement N° {contract_id}</p></h3>
<p>
...
<p>
	<strong>Artcle 4 :</strong> In the contract signed by the borrowers, the borrower authorizes the EPSSF to retract on his/her balance at Employeer, Rwamagana (salary, notice, paid leave, etc.) the amount left to pay if he ends his contract with EPSSF, Eastern Province. 
</p>
<p>
	<strong>Artcle 5 :</strong> The loan agreement and repayment authorizes the .................... Mutual Fund to block, for his benefit, the accounts of the borrower and the endorser up to the amount owed by the borrower to the EPSSF 
</p>
<p>
...
<p style="text-align: center">Done at Rwamagana, at <strong>{today_date}</strong>.</p>
<div class="container">
	<div class="left">
