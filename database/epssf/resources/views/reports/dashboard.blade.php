...
<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 bg-gray-200 pr-2 border-r border-gray-300" >
<h4 class="bg-green-100 text-green-900 font-light uppercase py-2 text-xl text-center">{{ trans('report.contribution_per_month') }}</h4>
        <canvas id="chart-area1" />
</div> 
<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 bg-gray-200 pr-2 border-r border-gray-300" >
<h4 class="bg-green-100 text-green-900 font-light uppercase py-2 text-xl text-center">{{ trans('report.member_per_institution') }}</h4>
	<canvas id="chart-area2" />
</div> 
<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 bg-gray-200 pr-2 border-r border-gray-300" >
<h4 class="bg-green-100 text-green-900 font-light uppercase py-2 text-xl text-center">{{ trans('report.given_loan_per_month') }}</h4>
        <canvas id="chart-area3" />
</div> 
<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 bg-gray-200 pr-2 border-r border-gray-300" >
<h4 class="bg-green-100 text-green-900 font-light uppercase py-2 text-xl text-center">{{ trans('report.given_loan_per_insitution') }}</h4>
