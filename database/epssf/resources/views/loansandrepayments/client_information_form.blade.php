...
<div class="row">
  ...
  <div class="form-group">
   <label>{{ trans('member.adhersion_number') }}</label>
	{!! Form::input('text', 'adhersion_id',isset($member)?$member->adhersion_id:null, 
                  ['class'=>'form-control','id'=> 'js-adhersion-id']) !!}
  </div>
  </div>
  <div class="col-md-3">
  <div class="form-group">
...
<div class="row">
  ...
  <div class="form-group">
   <label>{{ trans('member.letter_date') }}</label>
	{!! Form::input('text', 'letter_date',date('Y-m-d'), ['class'=>'form-control','id'=>'letter_date']) !!}
  </div>
  </div>
  <div class="col-md-2">
  <div class="form-group">
   <label>{{ trans('member.date_of_today') }}</label>
	{!! Form::input('text', 'date_of_today',date('Y-m-d'), ['class'=>'form-control','id'=>'today']) !!}
  </div>
  </div>
</div>
</div>