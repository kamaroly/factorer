<table class="table table-bordered">
	<caption>
		<h4 class="markdown mb-6 px-6 max-w-3xl mx-auto lg:ml-0 lg:mr-auto xl:mx-0 xl:px-12 xl:w-3/4">
			{{ trans('general.add_another_contribution_to_this_transaction') }}
		</h4>
	</caption>
  	 <thead>
  	 	<tr>
        <th> {{ trans('member.adhersion_number') }}</th>
        <th> {{ trans('member.fees') }}</th>
  	 		<th></th>
  	 	</tr>
   	 </thead>
	{!! Form::open(array('route' => array('corrections.contributions.add'), 'method' => 'POST')) !!}
	<tr>
