...
$(document).on('change', '#upload-photo:file', function() {
  ...
  $(document).ready(function(){
    ...
    suggestion: Handlebars.compile('<div class="autocomplete-wrapper"><p class="item-content" ><img src="/files/get/{{photo}}" align="left"> <span class="adhersion_number">{{adhersion_id}}</span> <span class="names">{{first_name}} {{last_name}} ({{ member_nid }})</span> <span class="service">{{service}} - {{institution}} (Employee ID : {{employee_id}} )</span><p></div>')
    }
    ...
    $('#interest-year').on('change', function() {
      window.location.href = window.location.protocol + '//' +window.location.host+window.location.pathname+'?interest-year='+this.value;
    });
    ...
    $('#recurrence').on('change',function(event) {
      window.location.href = window.location.protocol+'//'+window.location.host+window.location.pathname+'?recurrence='+this.value;
    });
  });
